...
while True:
    ...
    if len(lmlist) != 0:
        ...
        if mouseFlag:
            ...
            cv2.rectangle(img, (frameR, frameR), (wVisal - frameR, hVisal - frameR), (255, 0, 255), 2)
            cv2.rectangle(img2, (frameR, frameR), (wVisal - frameR, hVisal - frameR), (255, 0, 255), 2)
            # 座標計算
            x, y = lmlist[0][12][1] - frameR, lmlist[0][12][2] - frameR
            x, y = (int(x / (wVisal - (frameR * 2)) * wWin), int(y / (hVisal - (frameR * 2)) * hWin),)
